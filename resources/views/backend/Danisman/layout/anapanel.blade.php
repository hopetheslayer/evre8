...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="evre8/assets/vendors/css/chartist.min.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN APEX CSS-->
                ...
                <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                    <li class="has-sub nav-item"><a href="#"><i class="ft-aperture"></i><span data-i18n="" class="menu-title">Hesaplar</span></a>
                        <ul class="menu-content" style="">
                            <li class=""><a href="text-utilities.html" class="menu-item">Yöneticiler</a>
                            </li>
                            <li class=""><a href="text-utilities.html" class="menu-item">Psikologlar</a>
                            </li>
                            <li class=""></i><a href="{{route('hesaplar.users')}}" class="menu-item"><i class="ft-user"></i>Danışanlar</a>
                            </li>
                            <li class=""><a href="{{route('yasak.users')}}" class="menu-item"><i class="ft-user-x"></i>Yasaklanan Listesi</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="#"><i class="ft-clipboard"></i><span data-i18n="" class="menu-title">Randevular</span></a>
                        <ul class="menu-content" style="">
                            <li class=""><a href="text-utilities.html" class="menu-item">Text Utilities</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="#"><i class="ft-layers"></i><span data-i18n="" class="menu-title">Sayfalar</span></a>
                        <ul class="menu-content" style="">
                            <li class=""><a href="text-utilities.html" class="menu-item">Text Utilities</a>
                            </li>
                        </ul>
                    ...
                    <li class="has-sub nav-item"><a href="#"><i class="ft-settings"></i><span data-i18n="" class="menu-title">Tema Ayarları</span></a>
                        <ul class="menu-content" style="">
                            <li class=""><a href="text-utilities.html" class="menu-item">Text Utilities</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="#"><i class="ft-shield"></i><span data-i18n="" class="menu-title">Ayarlar</span></a>
                        <ul class="menu-content" style="">
                            <li class=""><a href="text-utilities.html" class="menu-item">Text Utilities</a>
                            </li>
                        </ul>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-user font-medium-3 blue-grey darken-4"></i>
                                ...
                                <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <form id="logout-form" action="{{ route('danisman.logout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
...
<script src="evre8/assets/vendors/js/chartist.min.js" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN APEX JS-->
...
<!-- END APEX JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="evre8/assets/js/dashboard1.js" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
</body>
