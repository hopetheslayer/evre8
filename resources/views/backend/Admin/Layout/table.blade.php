...
<head>
    ...
    <title>Advanced DataTable - Apex responsive bootstrap 4 admin template</title>
    ...
    <link rel="stylesheet" type="text/css" href="/evre8/assets/vendors/css/tables/datatable/datatables.min.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN APEX CSS-->
        ...
        <div class="sidebar-content">
            <div class="nav-container">
                <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                    <li class="has-sub nav-item"><a href="#"><i class="ft-aperture"></i><span data-i18n="" class="menu-title">Hesaplar</span></a>
                        <ul class="menu-content" style="">

                            <li class=""><a href="{{route('psikolog.users')}}" class="menu-item"><i class="ft-user-check"></i>Psikologlar</a>
                            </li>
                            <li class=""><a href="{{route('hesaplar.danisman.users')}}" class="menu-item"><i class="ft-user-minus"></i>Danışmanlar</a>
                            </li>
                            </li>
                            <li class=""><a href="{{route('yasak.users')}}" class="menu-item"><i class="ft-user-x"></i>Yasaklanan Listesi</a>
                            </li>
                        </ul>
                    </li>

                    <li class="has-sub nav-item"><a href="#"><i class="ft-aperture"></i><span data-i18n="" class="menu-title">Onay Bekleyenler</span></a>
                        <ul class="menu-content" style="">

                            <li class=""><a href="{{route('psikolog.users')}}" class="menu-item"><i class="ft-user-check"></i>Psikologlar</a>
                            </li>
                            <li class=""><a href="{{route('hesaplar.danisman.users')}}" class="menu-item"><i class="ft-user-minus"></i>Danısan</a>
                            </li>
                            </li>
                        </ul>
                    </li>

                    <li class=""><a href="{{route('Admin-randevular.index')}}"><i class="ft-clipboard"></i><span data-i18n="" class="menu-title">Randevular</span></a></li>

                    <li class=""><a href="{{route('admin.ticket')}}"><i class="ft-cast"></i><span data-i18n="" class="menu-title">Destek Biletleri</span></a></li>

                    <li class="has-sub nav-item"><a href="#"><i class="ft-activity"></i><span data-i18n="" class="menu-title">Ödemeler</span></a>
                        <ul class="menu-content" style="">
                            <li class=""><a href="text-utilities.html" class="menu-item">Text Utilities</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-sub nav-item"><a href="#"><i class="ft-settings"></i><span data-i18n="" class="menu-title">Ayarlar</span></a>
                        <ul class="menu-content" style="">
                            <li class=""><a href="{{route('Admin-tema-ayarlari.index')}}" class="menu-item">Tema Genel Ayarlar</a>
                            </li>
                            <li class=""><a href="{{route('admin.tema.anasayfa.getir')}}" class="menu-item">Anasayfa Genel Ayarlar</a>
                            </li>
                    ...
                    <div id="navbarSupportedContent" class="collapse navbar-collapse">
                        <ul class="navbar-nav">
                            ...
                            <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-flag font-medium-3 blue-grey darken-4"></i><span class="selected-language d-none"></span></a>
                                <div class="dropdown-menu dropdown-menu-right"><a href="javascript:;" class="dropdown-item py-1"><img src="/evre8/assets/img/flags/us.png" class="langimg"/><span> English</span></a><a href="javascript:;" class="dropdown-item py-1"><img src="/evre8/assets/img/flags/es.png" class="langimg"/><span> Spanish</span></a><a href="javascript:;" class="dropdown-item py-1"><img src="/evre8/assets/img/flags/br.png" class="langimg"/><span> Portuguese</span></a><a href="javascript:;" class="dropdown-item"><img src="/evre8/assets/img/flags/de.png" class="langimg"/><span> French</span></a></div>
                            </li>
                            ...
                            <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-user font-medium-3 blue-grey darken-4"></i>
                                ...
                                <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="javascript:;" class="dropdown-item py-1">
                                        <i class="ft-edit mr-2"></i><span>Edit Profile</span></a>
...
<script src="/evre8/assets/vendors/js/datatable/datatables.min.js" type="text/javascript"></script>
<script src="/evre8/assets/vendors/js/datatable/dataTables.buttons.min.js" type="text/javascript"></script>
<script src="/evre8/assets/vendors/js/datatable/buttons.flash.min.js" type="text/javascript"></script>
<script src="/evre8/assets/vendors/js/datatable/jszip.min.js" type="text/javascript"></script>
<script src="/evre8/assets/vendors/js/datatable/pdfmake.min.js" type="text/javascript"></script>
<script src="/evre8/assets/vendors/js/datatable/vfs_fonts.js" type="text/javascript"></script>
<script src="/evre8/assets/vendors/js/datatable/buttons.html5.min.js" type="text/javascript"></script>
<script src="/evre8/assets/vendors/js/datatable/buttons.print.min.js" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN APEX JS-->
