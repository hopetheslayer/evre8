@extends('backend.Danisan.layout.form')
...
@section('form-content')
    ...
    <form class="login100-form validate-form" method="POST" action="{{ route('danisan.login.submit') }}">
        @csrf
        ...
        <div class="form-group">
            <div class="col-md-12">
                <button type="submit" class="btn login100-form-btn">Giriş</button>
            </div>
        </div>
        ...
        <div class="text-center p-t-46 p-b-20">
            ...
            <a href="{{route('danisan.kaydol')}}" type="submit" class="btn btn-quaternary">Üye Ol</a>
        </div>
