        ...
        <div class="row">
            ...
            <div class="col-lg-9 order-lg-1">
                ...
                <div class="blog-posts">
                    @if ($blog->isEmpty())
                        <p style="text-align:center; font-size: 23px; margin-top: 250px;"><u>Bu konuya Ait Makale Bulunamamıştır.</u></p>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="post-content">
                                        <h2 class="font-weight-semibold text-7 line-height-4 mb-2">{{$bg->post_baslik}}<a href="blog-post.html"></a></h2>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="post-meta">
                                        ...
                                        <span class="text-4"><i class="far fa-user"></i><a href="#"></a> {{$bg->psikolog->name}} {{$bg->psikolog->sname}}</span>
                                        <span class="text-4"><i class="far fa-folder"></i><a href="#"></a>{{$bg->blogkategori->kategori_adi}} </span>

                                        <span class="d-block d-sm-inline-block float-sm-right mt-3 mt-sm-0"><a href="{{route('sblog',$bg->slug)}}" class="btn btn-xs btn-light text-1 text-uppercase">Daha Fazla</a></span>
                                    </div>
                                </div>
                            </div>
                        </article>
